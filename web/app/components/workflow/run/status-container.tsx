  ...
  return (
    <div
      ...
      className={cn(
        ...
        status === 'succeeded' &&
          `border-[rgba(23,178,106,0.8)] bg-workflow-display-success-bg ${styles.successBackground} text-text-success`,
        status === 'succeeded' &&
          theme === Theme.light &&
        ...
        status === 'partial-succeeded' &&
          ...
          'shadow-[inset_2px_2px_0_0_rgba(255,255,255,0.12),inset_0_1px_3px_0_rgba(0,0,0,0.4),inset_0_2px_24px_0_rgba(23,178,106,0.25),0_1px_2px_0_rgba(0,0,0,0.1),0_0_0_1px_rgba(24,24,27,0.95)]',
        status === 'failed' &&
          `border-[rgba(240,68,56,0.8)] bg-workflow-display-error-bg ${styles.errorBackground} text-text-warning`,
        status === 'failed' &&
          theme === Theme.light &&
        ...
        (status === 'stopped' || status === 'paused') &&
          `border-[rgba(247,144,9,0.8)] bg-workflow-display-warning-bg ${styles.warningBackground} text-text-destructive`,
        (status === 'stopped' || status === 'paused') &&
          theme === Theme.light &&
        ...
        status === 'exception' &&
          ...
          'shadow-[inset_2px_2px_0_0_rgba(255,255,255,0.12),inset_0_1px_3px_0_rgba(0,0,0,0.4),inset_0_2px_24px_0_rgba(247,144,9,0.25),0_1px_2px_0_rgba(0,0,0,0.1),0_0_0_1px_rgba(24,24,27,0.95)]',
        status === 'running' &&
          `border-[rgba(11,165,236,0.8)] bg-workflow-display-normal-bg ${styles.runningBackground} text-util-colors-blue-light-blue-light-600`,
        status === 'running' &&
          theme === Theme.light &&
    ...
    >
      <div
        className={cn(
          ...
          theme === Theme.light && styles.lightHighlight,
          theme === Theme.dark && styles.darkHighlight,
        )}
      ></div>
      {children}
      {isCopyable && (
